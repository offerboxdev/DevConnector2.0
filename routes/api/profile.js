...
router.delete("/", auth, async (req, res) => {
  try {
    ...
    // Remove profile
    await Profile.findOneAndRemove({ user: req.user.id }); // Field is user
    // Remove user
    await User.findOneAndRemove({ _id: req.user.id }); // Field is _id!
...
router.put(
  ...
  async (req, res) => {
    ...
    try {
      ...
      profile.experience.unshift(newExp); // unshift adds to the beginning
